...
public class ServiceRequestDAO {
        ...
        try (Connection connection = DBConnection.getConnection();
            ...
            try (ResultSet resultSet = statement.executeQuery()) {
                ...
                while (resultSet.next()) {
                    serviceRequests.add(mapRow(resultSet));
                }
            }
        }
    ...
    public Long create(ServiceRequest serviceRequest)
        ...
        try (Connection connection = DBConnection.getConnection();
            ...
            statement.setLong(1, serviceRequest.getProductId());
            statement.setString(2, serviceRequest.getComplaintDescription());
    ...
    private ServiceRequest mapRow(ResultSet resultSet)
        ...
        serviceRequest.setComplaintDescription(
                resultSet.getString("complaint_description")
        );
